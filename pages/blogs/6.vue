  ...
  <section class="blog">
    ...
    <div class="blog__container">
      <div class="blog__wrapper">
        <h1 class="blog__title">{{ $t('blog-6.title') }}</h1>
        <h2 class="blog__subtitle">
          {{ $t('blog-6.description') }}
        </h2>
        <img src="/img/blog-6-0.jpg" alt="img" class="blog__img" />
        <h3 class="blog__subtitle-2">{{ $t('blog-6.subtitle-1') }}</h3>
        <p class="blog__description">
          {{ $t('blog-6.subtitle-1-description') }}
        </p>
        <ul class="list-reset blog__list">
          <li class="blog__item">
            <p class="blog__item-text">
              {{ $t('blog-6.subtitle-1-item-1') }}
            </p>
          </li>
          <li class="blog__item">
            <p class="blog__item-text">
              {{ $t('blog-6.subtitle-1-item-2') }}
            </p>
          </li>
          <li class="blog__item">
            <p class="blog__item-text">
              {{ $t('blog-6.subtitle-1-item-3') }}
            </p>
          </li>
          <li class="blog__item">
            <p class="blog__item-text">
              {{ $t('blog-6.subtitle-1-item-4') }}
            </p>
          </li>
        </ul>
        <h3 class="blog__subtitle-2">{{ $t('blog-6.subtitle-2') }}</h3>
        <p class="blog__description">
          {{ $t('blog-6.subtitle-2-description') }}
        </p>
        <p class="blog__description">
          {{ $t('blog-6.subtitle-2-description-2') }}
        </p>
        <h3 class="blog__subtitle-2">{{ $t('blog-6.subtitle-3') }}</h3>
        <p class="blog__description">
          {{ $t('blog-6.subtitle-3-description') }}
        </p>
        <p class="blog__description">
          {{ $t('blog-6.subtitle-3-description-2') }}
        </p>
        <ul class="list-reset blog__list">
          <li class="blog__item">
            <p class="blog__item-text">
              {{ $t('blog-6.subtitle-3-item-1') }}
            </p>
          </li>
          <li class="blog__item">
            <p class="blog__item-text">
              {{ $t('blog-6.subtitle-3-item-2') }}
            </p>
          </li>
          <li class="blog__item">
            <p class="blog__item-text">
              {{ $t('blog-6.subtitle-3-item-3') }}
            </p>
          </li>
          <li class="blog__item">
            <p class="blog__item-text">
              {{ $t('blog-6.subtitle-3-item-4') }}
            </p>
          </li>
        </ul>
        <p class="blog__description">
          {{ $t('blog-6.subtitle-3-description-3') }}
        </p>
      </div>
    </div>
    <Footer />
